...

        {
          typeCard === 'listCountriesCard' ? (
            ...
            <div className="card-body p-4">
              <h5 className="card-title">Maior probablidade de origem: 
              <p className='text-center mt-2 mb-0 text-uppercase text-success'>{nameCountry}</p></h5>
              <div className='mb-4 d-flex justify-content-center'>
                <img src={`${flagCountry}`} width="35" alt="flag" />
              </div>
              <p className="card-text text-center ">A probabilidade é de <span className='fw-bold'>
                {probability}% </span></p>
